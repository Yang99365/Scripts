...
public abstract class BattleState : State 
{
	...
	public List<GeneralUnit> units { get { return owner.units; }}
  ...
  protected virtual void Awake ()
	...
	protected virtual GeneralUnit GetUnit (Point p)
	{
		Tile t = board.GetTile(p);
		GameObject content = t != null ? t.content : null;
		return content != null ? content.GetComponent<GeneralUnit>() : null;
	}
	protected virtual void RefreshPrimaryStatPanel (Point p)
	{
		GeneralUnit target = GetUnit(p);
		if (target != null)
